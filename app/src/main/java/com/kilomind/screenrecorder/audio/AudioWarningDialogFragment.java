...
import static com.kilomind.screenrecorder.Tracker.AUDIO_WARNING;
...
public class AudioWarningDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        messageView.setText(getString(R.string.internal_audio_warning_message, getString(R.string.free_app_name)).replaceAll("\\s*\\n\\s*", " ").trim());
