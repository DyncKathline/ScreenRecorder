...
import com.kilomind.screenrecorder.audio.AudioDriver;
import com.kilomind.screenrecorder.audio.AudioWarningActivity;
import com.kilomind.screenrecorder.audio.InstallationStatus;
import com.kilomind.screenrecorder.settings.AudioSource;
import com.kilomind.screenrecorder.settings.Settings;
import com.kilomind.screenrecorder.settings.SettingsActivity;
import com.kilomind.screenrecorder.stats.RecordingStatsAsyncTask;
...
import static com.kilomind.screenrecorder.Tracker.ACTION;
import static com.kilomind.screenrecorder.Tracker.AUDIO;
import static com.kilomind.screenrecorder.Tracker.RECORDING;
import static com.kilomind.screenrecorder.Tracker.SETTINGS;
import static com.kilomind.screenrecorder.Tracker.SIZE;
import static com.kilomind.screenrecorder.Tracker.START;
import static com.kilomind.screenrecorder.Tracker.STATS;
import static com.kilomind.screenrecorder.Tracker.STOP;
import static com.kilomind.screenrecorder.Tracker.STOP_DESTROY;
import static com.kilomind.screenrecorder.Tracker.STOP_ICON;
import static com.kilomind.screenrecorder.Tracker.TIME;
...
public class RecorderService extends Service implements IRecorderService, AudioDriver.OnInstallListener, IRecordingProcess.RecordingProcessObserver {
    ...
    private void displayStopHelp() {
        ...
        String message = String.format(getString(R.string.help_stop_message), getString(R.string.free_app_name));
    ...
    private void startForeground() {
        NotificationCompat.Builder builder =
                new NotificationCompat.Builder(this)
                        .setContentTitle(getString(R.string.free_app_name));
        ...
        String CHANNEL_ID = "RecorderService";
        String CHANNEL_NAME = getString(R.string.free_app_name);
    ...
    private void shutDownError() {
        ...
        String message = getString(R.string.internal_audio_disabled_message, getString(R.string.free_app_name));
    ...
    private void showMiUiPopupError() {
        ...
        Intent intent = new Intent(RecorderService.this, DialogActivity.class);
        intent.putExtra(DialogActivity.MESSAGE_EXTRA, getString(R.string.miui_error_message, getString(R.string.free_app_name)));
