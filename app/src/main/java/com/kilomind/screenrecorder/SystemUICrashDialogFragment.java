...
public class SystemUICrashDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle(R.string.free_app_name);
        builder.setIcon(R.drawable.ic_launcher);
        builder.setMessage(getString(R.string.system_ui_crash_dialog_message, getString(R.string.free_app_name), getString(R.string.media_projection_remember_text)));
