...
import com.kilomind.screenrecorder.DirectoryChooserActivity;
import com.kilomind.screenrecorder.GusherDialogFragment;
...
import com.kilomind.screenrecorder.audio.AudioWarningDialogFragment;
...
public class SettingsFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener, Preference.OnPreferenceClickListener, AudioDriver.OnInstallListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String copyrightsStatement = getString(R.string.copyrights_statement, getString(R.string.free_app_name));
